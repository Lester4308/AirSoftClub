param([ValidateSet('Mono','IL2CPP')][string]$Backend='IL2CPP')
...
$p=Start-Process -FilePath $exe -WorkingDirectory $root -ArgumentList @('--club-ui-smoke','-force-d3d11','-screen-width','1280','-screen-height','800','-screen-fullscreen','0','-logFile',('"'+$log+'"')) -WindowStyle Hidden -PassThru
